...
impl AlertThresholds {
    ...
    pub fn set_critical_hit_rate(&self, rate: f64) {
        self.critical_hit_rate.store((rate * 1_000_000.0) as u64, Ordering::Relaxed);
    }
    ...
    pub fn set_memory_threshold(&self, threshold: f64) {
        self.memory_warning_threshold.store((threshold * 1_000_000.0) as u64, Ordering::Relaxed);
    }
    ...
    pub fn set_warning_hit_rate(&self, rate: f64) {
        self.warning_hit_rate.store((rate * 1_000_000.0) as u64, Ordering::Relaxed);
    }
