...
pub struct FallbackErrorProvider {
    ...
    error_tracker: Option<std::sync::Arc<crate::cache::types::statistics::multi_tier::ErrorRateTracker>>,
...
impl FallbackErrorProvider {
    ...
    pub fn with_real_systems(
        error_tracker: std::sync::Arc<crate::cache::types::statistics::multi_tier::ErrorRateTracker>,
    ...
    fn get_error_tracker(&self) -> Option<&crate::cache::types::statistics::multi_tier::ErrorRateTracker> {
...
impl ErrorRecoveryProvider for FallbackErrorProvider {
    ...
    fn get_mttr_ms(&self) -> u32 {
        ...
        if let Some(breakers) = self.get_circuit_breakers() {
            let total_recovery_time_ms: u64 = breakers.iter()
                .map(|b| b.get_recovery_timeout_ms())
                .sum();
