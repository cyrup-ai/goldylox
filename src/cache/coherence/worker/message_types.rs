...
#[derive(Debug, Clone)]
pub enum CoherenceRequest<K: CacheKey + Default + bincode::Encode + bincode::Decode<()> + serde::Serialize + serde::de::DeserializeOwned, V: CacheValue + Default + bincode::Encode + bincode::Decode<()> + serde::Serialize + serde::de::DeserializeOwned> {
    ...
    /// Request statistics
    #[allow(dead_code)] // MESI coherence - used in coherence statistics collection and monitoring
    GetStatistics {
        request_id: u64,
    },
...
#[derive(Debug, Clone)]
pub enum CoherenceResponse<K: CacheKey + Default + bincode::Encode + bincode::Decode<()> + serde::Serialize + serde::de::DeserializeOwned, V: CacheValue + Default + bincode::Encode + bincode::Decode<()> + serde::Serialize + serde::de::DeserializeOwned> {
    ...
    Statistics {
        request_id: u64,
        #[allow(dead_code)] // MESI coherence - used in coherence statistics reporting and telemetry
