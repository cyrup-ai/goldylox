...
pub fn put_if_absent_atomic<K: CacheKey + 'static, V: CacheValue + Default + 'static>(
    ...
    use crate::cache::tier::warm::global_api::{WarmTierCoordinator, WarmCacheRequest};
...
pub fn compare_and_swap_atomic<K: CacheKey + 'static, V: CacheValue + Default + PartialEq + 'static>(
    key: K, 
    expected: V, 
    new_value: V
