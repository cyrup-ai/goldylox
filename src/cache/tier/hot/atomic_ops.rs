...
pub fn put_if_absent_atomic<K: CacheKey + Default + 'static, V: CacheValue + 'static>(
    ...
    use crate::cache::tier::hot::thread_local::{HotTierCoordinator, CacheRequest};
...
pub fn compare_and_swap_atomic<K: CacheKey + Default + 'static, V: CacheValue + PartialEq + 'static>(
    key: K, 
    expected: V, 
    new_value: V
