//! Command-line interface for loxd daemon
//!
//! Provides commands for running, installing, and managing the Goldylox cache daemon.

use clap::{Parser, Subcommand};

#[derive(Parser, Debug)]
#[command(version, about = "Goldylox cache daemon")]
pub struct Args {
...
pub enum Cmd {
    ...
    Run {
        ...
        /// Use system-wide config (/etc/loxd/loxd.toml)
