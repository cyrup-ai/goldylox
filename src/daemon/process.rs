//! Unix daemon process management for loxd
//!
//! Provides daemonization functionality including double-fork, systemd integration,
//! and proper Unix daemon lifecycle management.
