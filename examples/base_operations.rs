...
use goldylox::{Goldylox, GoldyloxBuilder, CacheStrategy};
...
async fn test_basic_operations(cache: &Goldylox<String, String>) -> Result<(), Box<dyn std::error::Error + Send + Sync>> {
...
async fn test_statistics_analytics(cache: &Goldylox<String, String>) -> Result<(), Box<dyn std::error::Error + Send + Sync>> {
    println!("📊 STATISTICS & ANALYTICS");
    println!("-------------------------");

    // Zero-allocation statistics test data using static arrays
    static STATS_KEYS: [&str; 100] = [
        "stats_key_0", "stats_key_1", "stats_key_2", "stats_key_3", "stats_key_4",
        "stats_key_5", "stats_key_6", "stats_key_7", "stats_key_8", "stats_key_9",
        "stats_key_10", "stats_key_11", "stats_key_12", "stats_key_13", "stats_key_14",
        "stats_key_15", "stats_key_16", "stats_key_17", "stats_key_18", "stats_key_19",
        "stats_key_20", "stats_key_21", "stats_key_22", "stats_key_23", "stats_key_24",
        "stats_key_25", "stats_key_26", "stats_key_27", "stats_key_28", "stats_key_29",
        "stats_key_30", "stats_key_31", "stats_key_32", "stats_key_33", "stats_key_34",
        "stats_key_35", "stats_key_36", "stats_key_37", "stats_key_38", "stats_key_39",
        "stats_key_40", "stats_key_41", "stats_key_42", "stats_key_43", "stats_key_44",
        "stats_key_45", "stats_key_46", "stats_key_47", "stats_key_48", "stats_key_49",
        "stats_key_50", "stats_key_51", "stats_key_52", "stats_key_53", "stats_key_54",
        "stats_key_55", "stats_key_56", "stats_key_57", "stats_key_58", "stats_key_59",
        "stats_key_60", "stats_key_61", "stats_key_62", "stats_key_63", "stats_key_64",
        "stats_key_65", "stats_key_66", "stats_key_67", "stats_key_68", "stats_key_69",
        "stats_key_70", "stats_key_71", "stats_key_72", "stats_key_73", "stats_key_74",
        "stats_key_75", "stats_key_76", "stats_key_77", "stats_key_78", "stats_key_79",
        "stats_key_80", "stats_key_81", "stats_key_82", "stats_key_83", "stats_key_84",
        "stats_key_85", "stats_key_86", "stats_key_87", "stats_key_88", "stats_key_89",
        "stats_key_90", "stats_key_91", "stats_key_92", "stats_key_93", "stats_key_94",
        "stats_key_95", "stats_key_96", "stats_key_97", "stats_key_98", "stats_key_99"
    ];
    
    static STATS_VALUES: [&str; 100] = [
        "stats_value_0", "stats_value_1", "stats_value_2", "stats_value_3", "stats_value_4",
        "stats_value_5", "stats_value_6", "stats_value_7", "stats_value_8", "stats_value_9",
        "stats_value_10", "stats_value_11", "stats_value_12", "stats_value_13", "stats_value_14",
        "stats_value_15", "stats_value_16", "stats_value_17", "stats_value_18", "stats_value_19",
        "stats_value_20", "stats_value_21", "stats_value_22", "stats_value_23", "stats_value_24",
        "stats_value_25", "stats_value_26", "stats_value_27", "stats_value_28", "stats_value_29",
        "stats_value_30", "stats_value_31", "stats_value_32", "stats_value_33", "stats_value_34",
        "stats_value_35", "stats_value_36", "stats_value_37", "stats_value_38", "stats_value_39",
        "stats_value_40", "stats_value_41", "stats_value_42", "stats_value_43", "stats_value_44",
        "stats_value_45", "stats_value_46", "stats_value_47", "stats_value_48", "stats_value_49",
        "stats_value_50", "stats_value_51", "stats_value_52", "stats_value_53", "stats_value_54",
        "stats_value_55", "stats_value_56", "stats_value_57", "stats_value_58", "stats_value_59",
        "stats_value_60", "stats_value_61", "stats_value_62", "stats_value_63", "stats_value_64",
        "stats_value_65", "stats_value_66", "stats_value_67", "stats_value_68", "stats_value_69",
        "stats_value_70", "stats_value_71", "stats_value_72", "stats_value_73", "stats_value_74",
        "stats_value_75", "stats_value_76", "stats_value_77", "stats_value_78", "stats_value_79",
        "stats_value_80", "stats_value_81", "stats_value_82", "stats_value_83", "stats_value_84",
        "stats_value_85", "stats_value_86", "stats_value_87", "stats_value_88", "stats_value_89",
        "stats_value_90", "stats_value_91", "stats_value_92", "stats_value_93", "stats_value_94",
        "stats_value_95", "stats_value_96", "stats_value_97", "stats_value_98", "stats_value_99"
    ];
    ...
    match serde_json::from_str::<serde_json::Value>(&stats) {
        Ok(parsed_stats) => {
            println!("✓ stats() - Valid JSON: {} chars, {} keys", 
                stats.len(), 
    ...
    match serde_json::from_str::<serde_json::Value>(&analytics) {
        Ok(parsed_analytics) => {
            println!("✓ detailed_analytics() - Valid JSON: {} chars, {} keys", 
                analytics.len(),
...
async fn test_concurrent_operations(cache: &Goldylox<String, String>) -> Result<(), Box<dyn std::error::Error + Send + Sync>> {
    ...
    if swapped {
        ...
        println!("⚠ compare_and_swap() - Failed (may be implementation specific): {}", swapped);
    }
    ...
    println!("✓ get_or_insert_with() - Fallible success: {}", fallible_value);
    println!();
...
async fn test_batch_operations(cache: &Goldylox<String, String>) -> Result<(), Box<dyn std::error::Error + Send + Sync>> {
    ...
    println!("✓ batch_put() - {}/{} ops in {:?} ({:.2} ops/sec)",
    ...
    println!("✓ batch_get() - {}/{} found ({:.1}% hit rate, {:.2} ops/sec)",
    ...
    println!("✓ batch_remove() - {}/{} removed ({:.2} ops/sec)",
...
async fn test_cold_tier_compression(cache: &Goldylox<String, String>) -> Result<(), Box<dyn std::error::Error + Send + Sync>> {
    ...
    for i in 0..5000 {
        cold_tier_test_data.push((
            format!("large_key_{}", i),
            LARGE_VALUE_TEMPLATE.to_string()
        ));
    }
    ...
    let space_saved = cache.get_cold_tier_space_saved();
    println!("✓ get_cold_tier_space_saved() - {} bytes saved", space_saved);

    let effectiveness = cache.get_cold_tier_compression_effectiveness();
    println!("✓ get_cold_tier_compression_effectiveness() - {:.2}x ratio", effectiveness);
    ...
    println!("✓ get_cold_tier_avg_decompression_time() - {} ns", decomp_time);

    let comp_throughput = cache.get_cold_tier_compression_throughput();
    println!("✓ get_cold_tier_compression_throughput() - {:.2} MB/s", comp_throughput);

    let decomp_throughput = cache.get_cold_tier_decompression_throughput();
    println!("✓ get_cold_tier_decompression_throughput() - {:.2} MB/s", decomp_throughput);
    ...
    println!("✓ select_cold_tier_compression_for_workload() - {}", optimal);
    println!();
...
async fn test_strategy_management(cache: &Goldylox<String, String>) -> Result<(), Box<dyn std::error::Error + Send + Sync>> {
...
async fn test_task_coordination(cache: &Goldylox<String, String>) -> Result<(), Box<dyn std::error::Error + Send + Sync>> {
    ...
    println!("✓ get_task_coordinator_stats() - Active: {}, Completed: {}",
    ...
    println!("✓ get_maintenance_breakdown() - {} cycles completed",
    ...
    if let Some(first_task) = active_tasks.first() {
        ...
        println!("✓ cancel_task() - Task {} cancelled: {}", first_task.id, cancelled);
    }
    println!();
...
async fn test_async_operations(cache: &Goldylox<String, String>) -> Result<(), Box<dyn std::error::Error + Send + Sync>> {
    println!("🔄 ASYNC OPERATIONS");
    println!("-------------------");

    // Test async operation with computation
    let async_result = cache.schedule_async_operation(
    ...
    let error_result = cache.schedule_async_operation(
    ...
    println!("✓ schedule_async_operation() - {}/5 concurrent operations succeeded",
        successful_count
    );
    println!();
...
async fn test_shutdown_operations(cache: &Goldylox<String, String>) -> Result<(), Box<dyn std::error::Error + Send + Sync>> {
